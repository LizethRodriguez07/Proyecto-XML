...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnVerCarrito.setOnClickListener {
            if (carroCompras.isEmpty()) {
                Toast.makeText(this, "Por favor selecciona al menos un producto", Toast.LENGTH_SHORT).show()
            } else {
    ...
    private fun agregarProductos() {
        ...
        listaproductos.add(Producto("Nike Air Trainer", "Tallas: 39-42. Blanco/Gris", 380000.0, R.drawable.niked))
        listaproductos.add(Producto("ADIDAS FORUM", "Tallas: 37-41. Negro/Blanco", 350000.0, R.drawable.adidas4))
        listaproductos.add(Producto("PUMA STREET", "Tallas: 38-43. Azul/Gris", 320000.0, R.drawable.puma6))
        listaproductos.add(Producto("NEW BALANCE 1300", "Tallas: 39-44. Café", 280000.0, R.drawable.new6))
